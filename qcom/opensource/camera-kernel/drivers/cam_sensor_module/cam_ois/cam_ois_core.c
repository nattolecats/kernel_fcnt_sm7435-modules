...
extern int aw86006_ois_fw_download(struct cam_ois_ctrl_t *o_ctrl); /* zpf fw update add */
...
//zpf modify for nagoya ois fw update
#if 0
...
static int cam_ois_pkt_parse(struct cam_ois_ctrl_t *o_ctrl, void *arg)
{
	...
	case CAM_OIS_PACKET_OPCODE_INIT:
		...
		if (o_ctrl->ois_fw_flag) {
			//zpf modify for nogoya ois fw update
