...
/*<--! wangqidong@huaqin.com add headset detection add 20231219-->*/
#include <linux/of.h>
...
/*<--! wangqdiong@huaqin.com add headset detection add 20231219-->*/
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	switch_state = gpio_get_value(EAR_DET_EN);
	printk("EAR_DET_EN = %d , EAR_DET_IN = %d\n",gpio_get_value(EAR_DET_EN),gpio_get_value(EAR_DET_IN));
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_info("switch_state: %d", switch_state);
	return 0;
}
...
/*<--! wangqidong@huaqin.com add headset detection add 20231219-->*/
	...
	if (gpio_is_valid(EAR_DET_EN))
		printk(KERN_EMERG" EAR_DET_EN is  vaild\n");
	else
          printk(KERN_EMERG"EAR_DET_EN is invalid\n");
	...
	if (gpio_is_valid(EAR_DET_IN))
		printk(KERN_EMERG" EAR_DET_IN is  vaild\n");
	else
          printk(KERN_EMERG"EAR_DET_IN is invaild\n");
